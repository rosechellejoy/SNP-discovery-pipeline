...
def main(argv):
    ...
    #bam_validator = '/home/jdetras/software/bamUtil-1.0.13/bin/bam'
    #get arguments
    try:
    ...
    run = subprocess.call([bam_validator, 'validate', '--in', bam, '--verbose'], stdout=out, stderr=subprocess.STDOUT)
    print "Input:" + bam
